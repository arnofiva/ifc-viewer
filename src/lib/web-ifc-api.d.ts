 ...
 * @module web-ifc
 */
import { LogLevel } from "web-ifc/helpers/log";
import { Properties } from "web-ifc/helpers/properties";
import { IfcLineObject } from "web-ifc/ifc-schema";
export * from "web-ifc/ifc-schema";
export { Properties };
export { LogLevel };
